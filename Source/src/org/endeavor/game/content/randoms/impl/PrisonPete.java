...
public class PrisonPete extends RandomEvent {
	public static final int PRISON_PETE_ID = 3118;
	public static final Location[] FAILURE_LOCATIONS = { new Location(3079, 3493, 0) };

	@Override
	public void init(final Player player) {
		final Mob genie = new Mob(player, 3118, false, false, true, player.getLocation());
		...
		Task timeout = new Task(genie, 1) {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -134086094669871941L;
			byte stage = 0;
	...
	public void onSuccess(final Mob mob) {
		...
		TaskQueue.queue(new Task(mob, 2) {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -615458011904592036L;
			byte stage = 0;
