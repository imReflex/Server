...
public class Genie extends RandomEvent {
	public static final int GENIE_ID = 3022;
	public static final Location[] FAILURE_LOCATIONS = { new Location(3079, 3493, 0) };

	@Override
	public void init(final Player player) {
		final Mob genie = new Mob(player, 3022, false, false, true, player.getLocation());
		...
		Task timeout = new Task(genie, 1) {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -2972888141527172156L;
			byte stage = 0;
	...
	public void onSuccess(final Mob mob) {
		...
		TaskQueue.queue(new Task(mob, 2) {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 8839863566293994916L;
			byte stage = 0;
