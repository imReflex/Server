...
public class SpriteLoader {
	...
	public static void loadSprites(CacheArchive streamLoader) {
		try {
			Stream index = new Stream(streamLoader.getDataForName("sprites.idx"));
			Stream data = new Stream(streamLoader.getDataForName("sprites.dat"));
			...
			System.out.println("Loaded: " + totalSprites + " sprites[config index].");
			if (cache == null) {
